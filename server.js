...
const mustacheExpress = require('mustache-express'); //using mustache as a default package
const app = express();
...
app.use(express.static('public')); //tells the server that the static files are in public folder
app.use(bodyParser.urlencoded({ extended: false }));
app.get('/add', (req, res) => {

    res.render('med-form'); //create a template and render that  med  
});
...
app.post('/meds/add', (req, res) => {
    ...
    client.connect()
        ...
        .then((result) => {
            ...
            res.redirect('/meds'); //redirct the page
        });
});
// DASHBOARD
...
app.get('/meds', (req, res) => {
    ...
    client.connect()
        ...
        .then((results) => {
            ...
            res.render('meds', results); //create a template and render that  med 
        });
